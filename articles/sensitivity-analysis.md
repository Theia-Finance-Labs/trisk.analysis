...
[`pd-el-integration`](pd-el-integration.md) — no per-section translation
needed.
...
![](sensitivity-analysis_files/figure-html/unnamed-chunk-7-1.png)
...
![](sensitivity-analysis_files/figure-html/unnamed-chunk-8-1.png)
...
![](sensitivity-analysis_files/figure-html/unnamed-chunk-10-1.png)
...
![](sensitivity-analysis_files/figure-html/unnamed-chunk-11-1.png)
...
![](sensitivity-analysis_files/figure-html/unnamed-chunk-13-1.png)
...
![](sensitivity-analysis_files/figure-html/unnamed-chunk-14-1.png)
...
- [`getting-started`](getting-started.md) — the reading-path entry
  point.
- [`run-on-a-portfolio`](run-on-a-portfolio.md) — how the underlying
  TRISK runs that feed this analysis are produced.
- [`pd-el-integration`](pd-el-integration.md) — the full PD/EL
