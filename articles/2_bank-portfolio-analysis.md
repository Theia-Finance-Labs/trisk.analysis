...
outputs](3_inputs-and-outputs.md), [Run on a
portfolio](4_run-on-a-portfolio.md), [Sensitivity
analysis](5_sensitivity-analysis.md), [PD & EL
integration](6_pd-el-integration.md)) go deeper; start here.
...
For the [Sensitivity analysis](5_sensitivity-analysis.md) and [PD & EL
integration](6_pd-el-integration.md) workflows, add an `internal_pd`
...
- **[Inputs and outputs](3_inputs-and-outputs.md)** — every input column
  and every output table, in detail.
- **[Run on a portfolio](4_run-on-a-portfolio.md)** — the simple vs full
  runners, exposure allocation, and the plotting helpers.
- **[Sensitivity analysis](5_sensitivity-analysis.md)** — sweep shock
  year, IAM and ambition, read through a bank-impact lens.
- **[PD & EL integration](6_pd-el-integration.md)** — recombine TRISK
  PDs with your internal PDs and translate to expected-loss basis
  points.
