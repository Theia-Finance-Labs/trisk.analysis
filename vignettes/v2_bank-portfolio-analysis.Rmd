---
title: "2. Bank portfolio analysis — start here"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{2. Bank portfolio analysis - start here}
...
run. The vignettes that follow ([Inputs and outputs](v3_inputs-and-outputs.html),
[Run on a portfolio](v4_run-on-a-portfolio.html),
[Sensitivity analysis](v5_sensitivity-analysis.html),
[PD & EL integration](v6_pd-el-integration.html)) go deeper; start here.
...
For the [Sensitivity analysis](v5_sensitivity-analysis.html) and
[PD & EL integration](v6_pd-el-integration.html) workflows, add an `internal_pd`
...
- **[Inputs and outputs](v3_inputs-and-outputs.html)** — every input column and
  every output table, in detail.
- **[Run on a portfolio](v4_run-on-a-portfolio.html)** — the simple vs full runners,
  exposure allocation, and the plotting helpers.
- **[Sensitivity analysis](v5_sensitivity-analysis.html)** — sweep shock year, IAM
  and ambition, read through a bank-impact lens.
- **[PD & EL integration](v6_pd-el-integration.html)** — recombine TRISK PDs with
