...
[`pd-el-integration`](pd-el-integration.html) — no per-section translation
needed.
...
full methodology, see [`pd-el-integration`](pd-el-integration.html).

# See also

- [`getting-started`](getting-started.html) — the reading-path entry point.
- [`run-on-a-portfolio`](run-on-a-portfolio.html) — how the underlying TRISK
  runs that feed this analysis are produced.
- [`pd-el-integration`](pd-el-integration.html) — the full PD/EL integration
