---
title: "5. Sensitivity analysis (bank-impact view)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{5. Sensitivity analysis (bank-impact view)}
...
[`pd-el-integration`](v6_pd-el-integration.html) — no per-section translation
needed.
...
full methodology, see [`pd-el-integration`](v6_pd-el-integration.html).

# See also

- [`getting-started`](v1_getting-started.html) — the reading-path entry point.
- [`run-on-a-portfolio`](v4_run-on-a-portfolio.html) — how the underlying TRISK
  runs that feed this analysis are produced.
- [`pd-el-integration`](v6_pd-el-integration.html) — the full PD/EL integration
