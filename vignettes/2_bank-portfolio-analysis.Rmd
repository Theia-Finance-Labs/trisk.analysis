...
run. The vignettes that follow ([Inputs and outputs](3_inputs-and-outputs.html),
[Run on a portfolio](4_run-on-a-portfolio.html),
[Sensitivity analysis](5_sensitivity-analysis.html),
[PD & EL integration](6_pd-el-integration.html)) go deeper; start here.
...
For the [Sensitivity analysis](5_sensitivity-analysis.html) and
[PD & EL integration](6_pd-el-integration.html) workflows, add an `internal_pd`
...
- **[Inputs and outputs](3_inputs-and-outputs.html)** — every input column and
  every output table, in detail.
- **[Run on a portfolio](4_run-on-a-portfolio.html)** — the simple vs full runners,
  exposure allocation, and the plotting helpers.
- **[Sensitivity analysis](5_sensitivity-analysis.html)** — sweep shock year, IAM
  and ambition, read through a bank-impact lens.
- **[PD & EL integration](6_pd-el-integration.html)** — recombine TRISK PDs with
