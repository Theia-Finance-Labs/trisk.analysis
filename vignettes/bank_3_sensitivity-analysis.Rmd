...
> **Scope of the bundled IAM/ambition data.** NGFS2023 only publishes the
> REMIND and MESSAGE models — and the B2DS / DT ambition variants used in the
> next section — for the **Power sector**, spanning **2023–2050**. The legacy
> multi-sector `NGFS2023GCAM_*` scenarios used in the sections above run
> 2022–2100 across Coal, Oil & Gas, and Power. Because TRISK derives its
> analysis window from the scenario's own year range, we scope the portfolio to
> that window before running these two sections — keeping the cross-variant
> comparison apples-to-apples on the bank's power exposure.
...
- [`getting-started`](0_getting-started.html) — the reading-path entry point.
