...
Hold the scenario fixed and vary one knob to isolate its effect. For example,
sweep the DCF `discount_rate` across three values:
...
confirm that for your own book. The same pattern applies to every parameter
above; the rest of this vignette focuses on the three scenario dimensions.
